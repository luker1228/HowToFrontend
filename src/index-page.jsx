...
const faqs = [
  ...
  },
  {
    ...
    copy: "每门课程循序渐进，每节课都能直接改代码、实时看效果。先跑通最小例子，再理解概念，最后让 AI 帮你扩展。",
  },
  {
    title: "没有基础能跟上吗？",
    copy: "可以。每门课程都从「是什么、为什么」讲起，不假设你已是该领域工程师，但默认你愿意动手改一改、跑一跑。",
  },
];
            ...
            <div className="hero-grid">
              <div className="hero-copy-block">
                ...
                <p className="hero-subtitle-structured">
                  一个个看得见、改得动的实战教程。从 <CycleText items={["前端 Frontend", "Deploy", "更多 …"]} /> 开始，边改边学，用 AI 把知识变成能跑起来的东西。
                </p>
                <div className="hero-actions">
                  <a className="button" href={withBase(frontendTrack.href)}>开始学习 →</a>
                </div>
                <div className="hero-tags">
                  {["前端", "Deploy", "边改边学", "实战优先", "AI 协作"].map((tag) => (
              ...
              <aside className="hero-note">
                ...
                <p className="hero-note-copy">给设计师、产品、后端同学：不教你成为前端，而是让你把页面的结构、样式、组件说清楚。前端课程已上线，Deploy 等更多课程陆续推出。</p>
              </aside>
            </div>
          </section>
          ...
          <section className="section" id="tracks">
            <div className="section-header">
              <div className="section-kicker-wrap">
                ...
                <span className="section-kicker">课程</span>
              </div>
            </div>
            <div className="lesson-card-grid">
              {TRACKS.map((track) => (
                <a key={track.id} className="lesson-card" href={withBase(track.href)}>
                  <div className="lesson-card-preview track-card-preview" style={{ "--track-accent": track.accent }}>
                    <span className="track-card-mark">{track.tagline}</span>
                  </div>
        ...
        <footer className="footer">
          <div className="container footer-grid">
            <div className="footer-col">
              ...
              <p className="card-copy">HowToEverything：实战教学平台，每节课都能直接改代码、实时看效果。从前端开始，更多领域陆续上线。</p>
            </div>
            <div className="footer-col">
              <span className="footer-caption">前端课程目录</span>
              <a href={withBase("front/html.html")}>结构课</a>
              <a href={withBase("front/css.html")}>样式课</a>
              <a href={withBase("front/js.html")}>交互课</a>
              <a href={withBase("front/component.html")}>先认词</a>
              <a href={withBase("front/layout.html")}>布局第一课</a>
              <a href={withBase("front/layout-2.html")}>布局第二课</a>
            </div>
            <div className="footer-col">
            ...
            <div className="footer-col">
              ...
              <a href="#tracks" onClick={(e) => scrollToSection(e, "tracks")}>课程</a>
              <a href={withBase(frontendTrack.href)}>前端课程</a>
              <a href="#faq" onClick={(e) => scrollToSection(e, "faq")}>常见问题</a>
            </div>
          </div>
        </footer>
      </div>
